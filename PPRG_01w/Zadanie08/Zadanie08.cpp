...
int main() {
    ...
    do {    // Pętla warunkowa DO WHILE wykona polecenia przynajmniej raz, po czym sprawdzi warunek i jesli true powtorzy petle
        cout << "Podaj dzien 1: ";
        cin >> dzien1;
        if ( dzien1 > 31 || dzien1 < 1 ) cout << "Miesiąc ma od 1 do 31 dni. Sprobuj ponownie..." << endl;
    } while ( dzien1 > 31 || dzien1 < 1 );

    do {
        cout << "Podaj miesiac 1: ";
        cin >> miesiac1;
        if ( miesiac1 > 12 || miesiac1 < 1 ) cout << "Rok ma od 1 do 12 miesięcy. Sprobuj ponownie..." << endl;
    ...
    do {
        cout << "Podaj dzien 2: ";
        cin >> dzien2;
        if ( dzien2 > 31 || dzien2 < 1 ) cout << "Miesiąc ma od 1 do 31 dni. Sprobuj ponownie..." << endl;
    } while ( dzien2 > 31 || dzien2 < 1 );

    do {
        cout << "Podaj miesiac 2: ";
        cin >> miesiac2;
        if ( miesiac2 > 12 || miesiac2 < 1 ) cout << "Rok ma od 1 do 12 miesięcy. Sprobuj ponownie..." << endl;
    ...
    } while ( rok2 > 2023 || rok2 < 1 );

    cout << endl << dzien1 << "." << miesiac1 << "." << rok1 << " r. " << endl;
